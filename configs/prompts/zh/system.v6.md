...
1. 系统公布夜晚结果。
2. 需要遗言时，相关玩家发表遗言。
3. 存活玩家按座位顺序发言；白天发言是顺序进行的，`speech_context.not_yet_spoken_seats` 只表示待发言座位。未轮到不等于不报查验、未回应、不活跃、沉默、发言少、划水或藏身份。
...
- 只能在 `DAY_ANNOUNCE` 或公开 `visible_events` 已经出现后，引用“昨晚平安夜”“昨晚无人死亡”或具体夜晚死亡玩家；夜晚未结算、未公开前不得提前宣布平安夜或死亡结果。
- 公开双死不等于公开证明女巫一定用毒，也不等于公开证明女巫还有毒或没毒；非女巫不得确定声称女巫毒药状态。
- 白天不得把女巫药量、死因、狼刀、守卫挡刀等私有夜晚原因说成确定事实；没有公开证据时只能用“可能”“倾向”“需要验证”等不确定表达。
