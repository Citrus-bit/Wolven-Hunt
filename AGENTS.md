...
5. 当前默认固定 10 人板：3 狼人、4 村民、1 预言家、1 女巫、1 守卫。`classic_8` 仅作为旧日志/旧阶段兼容配置保留；新增板子只能通过配置扩展，不能把板子规则写死进核心代码。
...
- 允许在 STEP-06 后端外部接入基础上实现 per-seat LLM provider 路由、观赛 pacing/ack、叙事化事件流、role_reveal、final_reveal、前端音视频、倒计时、投票直方图、女巫夜晚行动状态和结局揭晓。
